import { checkPick, getPatternDuration, levelDown, nextLevel, startLevel, startSession } from './game.js';
import { getBestLevel, setBestLevel, getResultHistory, recordResult } from './storage.js';
import type { ResultEntry } from './storage.js';
import type { LevelState, UIOptions } from './types.js';
import {
...
export function initUI(options: UIOptions): void {
  ...
  document.documentElement.setAttribute('data-theme', options.initialScheme);
  ...
  const gridInputFeature = resolveGridInputFeature(document);
